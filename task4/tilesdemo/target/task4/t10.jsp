	...
	<div class="main container">
        ...
        <div class="main-a row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                <p>
                    <img src="${pageContext.request.contextPath}/imges/453254312.png">12400<br>
        ...
        <div class="main-c row">
            ...
            <ul class="list-unstyled text-center">
                ...
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img width="100px" src="${pageContext.request.contextPath}/imges/20171222172526.jpg">
                        <span>${l.type}:${l.name}</span>
                        <label>毕业时间：
                            <!-- 通过jsp:userBean标签引入java.util.Date日期类 -->
                            <jsp:useBean id="dateValue" class="java.util.Date"/>
                            <!-- 使用jsp:setProperty标签将时间戳设置到Date的time属性中 -->
                            <jsp:setProperty name="dateValue" property="time" value="${l.create_at}"/>
                             <!-- 转换格式 时间戳->日期格式 -->
                            <fmt:formatDate value="${dateValue}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </label>
                        <p class="text-left">${l.description}</p>
                    </div>
                </li>
                </c:forEach>
            </ul>
