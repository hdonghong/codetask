            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    <div class="clearfix">
                        ...
                        <div class="text">
                            <h4 class="">${l.job}</h4>
                            <p class="text-present">${l.description}</p>
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">难易程度
                                <c:forEach begin="1" end="${l.degree}">
                                <img src="${pageContext.request.contextPath}/imges/xx.png">
                                </c:forEach>
                            </div>
                        </div>
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color">${l.demand}</span>家公司需要</div>
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        <b class="text-b">有${l.students}正在学</b>
                    </div>
                    <div class="warp-class2">
                        <p class="text-p">提示:${l.message}</p>
                    </div>

                    <div class="flip-container">
                        <p class="flip-title">${l.job}</p>
                        <p class="flip-text">${l.description}</p>
                    </div>
                </div>
